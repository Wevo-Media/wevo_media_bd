"""
Django settings for wevo_media_project project.
"""
...
SECRET_KEY = 'django-insecure-wevo-media-project-2024-academic-work'
...
WSGI_APPLICATION = 'wevo_media_project.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': os.getenv('DB_NAME', 'wevo_media'),
